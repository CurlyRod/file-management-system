...
require_once '../../class/client/file-management.php';
...
if (isset($_POST['action']) && $_POST['action'] === "get_all_files") { 
    ...
    $usersFiles = $fileManagement->GetAllUserFilesByID($user_id);  
  //   echo json_encode($usersFiles);
    if (!empty($usersFiles )) {
        
        $output = '<table id="user-files-container-table" class="table table-striped table-responsive" style="width:100%; font-size:0.8rem;">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Filename</th>   
